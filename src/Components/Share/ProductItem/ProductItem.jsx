...
const ProductItem = ({ product }) => {
    ...
    return (
        <div className='group p-[10px] border rounded-[10px] bg-white shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]'>
            ...
            <div onClick={() => showSingleProduct(product.id)} className="cursor-pointer">
                <div className="pt-[15px]">
                    ...
                    <h2 className='cursor-pointer text-[18px] font-[400] leading-[120%] text-[rgba(56, 56, 56, 1)] Poppins py-[10px]'>{product.productName}</h2>
                </div>
