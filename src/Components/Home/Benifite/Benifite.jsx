...
const Benifite = () => {
  ...
  return (
    <div className='border-b bg-white'>
      <div className="containerMb lg:container py-[50px] gap-[25px] grid-cols-1 grid lg:grid-cols-4">
        <div className="flex justify-start lg:justify-center items-center gap-[18px]">
                <div className="">
                <img className='w-[40px]'  src={vector} alt="" />
            </div>
            <div className="">
                <h3 className='text-[20px] font-[500] text-black Poppins leading-normal'>FREE SHIPPING</h3>
                <p className='text-[18px] font-[400] text-[#757575] Poppins leading-normal'>Order via Campaign</p>
            </div>
        </div>
        <div className="flex justify-start lg:justify-center items-center gap-[18px]">
            <div className="">
                <img className='w-[40px]' src={vector1} alt="" />
            </div>
            <div className="">
        ...
        <div className="flex justify-start lg:justify-center items-center gap-[18px]">
            <div className="">
                <img className='w-[40px]' src={vector2} alt="" />
            </div>
            <div className="">
        ...
        <div className="flex justify-start lg:justify-center items-center gap-[18px]">
            <div className="">
                <img className='w-[40px]' src={vector3} alt="" />
            </div>
            <div className="">
